        ...
        <menu class="grid-container" style="margin: auto;">
            ...
            <menu class="vertical-options-menu">
                ...
                <div id="track-selection-menu">
                    ...
                    <div @click="$emit('open-recording-page')" class="add-item-container">
...
export default defineComponent({
    ...
    setup(props, context) {
        ...
        return { metronome, drag, mouse_down, openSingleVideoEditor, playhead, screenStyle, setScreenStyle, track_data, tracks, stream_url }
